...
/home/ubuntu/Desktop/ZenOS/user/build/riscv64/_test_main:     file format elf64-littleriscv
...
int main(int argc, char *argv[]) {
    ...
    1004:	e84a                	sd	s2,16(sp)
    1006:	892a                	mv	s2,a0
    1008:	ec26                	sd	s1,24(sp)
    printf("argc=%d\n", argc);
    100a:	00001517          	auipc	a0,0x1
    100e:	d4650513          	addi	a0,a0,-698 # 1d50 <sharedmem+0xc>
int main(int argc, char *argv[]) {
    1012:	84ae                	mv	s1,a1
    printf("argc=%d\n", argc);
    1014:	85ca                	mv	a1,s2
int main(int argc, char *argv[]) {
    1016:	f406                	sd	ra,40(sp)
    1018:	f022                	sd	s0,32(sp)
    101a:	e44e                	sd	s3,8(sp)
    printf("argc=%d\n", argc);
    101c:	0ca000ef          	jal	ra,10e6 <printf>

    for (int i = 0; i < argc; i++)
    1020:	03205063          	blez	s2,1040 <main+0x3e>
    1024:	4401                	li	s0,0
    {
        printf("argv[%d]=%s\n", i, argv[i]);
    1026:	00001997          	auipc	s3,0x1
    102a:	d3a98993          	addi	s3,s3,-710 # 1d60 <sharedmem+0x1c>
    102e:	6090                	ld	a2,0(s1)
    1030:	85a2                	mv	a1,s0
    1032:	854e                	mv	a0,s3
    for (int i = 0; i < argc; i++)
    1034:	2405                	addiw	s0,s0,1
        printf("argv[%d]=%s\n", i, argv[i]);
    1036:	0b0000ef          	jal	ra,10e6 <printf>
    for (int i = 0; i < argc; i++)
    103a:	04a1                	addi	s1,s1,8
    103c:	fe8919e3          	bne	s2,s0,102e <main+0x2c>
    }
    ...
    1044:	64e2                	ld	s1,24(sp)
    1046:	6942                	ld	s2,16(sp)
    1048:	69a2                	ld	s3,8(sp)
    104a:	4501                	li	a0,0
...
int putchar(int c)
{
    ...
    1088:	d0c58593          	addi	a1,a1,-756 # 1d90 <put.1156>
...
int puts(const char* s)
{
    ...
    10c8:	ccc58593          	addi	a1,a1,-820 # 1d90 <put.1156>
    10cc:	47a9                	li	a5,10
    return write(stdout, put, 1);
    10ce:	4605                	li	a2,1
    10d0:	4505                	li	a0,1
...
void printf(const char* fmt, ...) {
    ...
    112c:	c6840413          	addi	s0,s0,-920 # 1d90 <put.1156>
            continue;
        }
        c = fmt[++i] & 0xff;
        if (c == 0)
    ...
    113a:	c62a0a13          	addi	s4,s4,-926 # 1d98 <put.1156+0x8>
    113e:	00001997          	auipc	s3,0x1
    1142:	cb298993          	addi	s3,s3,-846 # 1df0 <digits>
    ...
    123a:	b5a58593          	addi	a1,a1,-1190 # 1d90 <put.1156>
    123e:	4505                	li	a0,1
    put[0] = c;
    ...
    124e:	b4658593          	addi	a1,a1,-1210 # 1d90 <put.1156>
    1252:	4505                	li	a0,1
    put[0] = c;
    ...
    127a:	b1a58593          	addi	a1,a1,-1254 # 1d90 <put.1156>
    127e:	4505                	li	a0,1
    put[0] = c;
    ...
    12f0:	aa458593          	addi	a1,a1,-1372 # 1d90 <put.1156>
                printptr(va_arg(ap, uint64));
    ...
    1316:	a7e58593          	addi	a1,a1,-1410 # 1d90 <put.1156>
    131a:	4505                	li	a0,1
    put[0] = c;
    ...
    13c6:	9ce58593          	addi	a1,a1,-1586 # 1d90 <put.1156>
    13ca:	4505                	li	a0,1
    put[0] = c;
    ...
    141c:	958d0d13          	addi	s10,s10,-1704 # 1d70 <sharedmem+0x2c>
                for (; *s; s++)
...
size_t strlen(const char* s)
{
    ...
    173c:	6405b583          	ld	a1,1600(a1) # 1d78 <sharedmem+0x34>
    1740:	00000617          	auipc	a2,0x0
    1744:	64063603          	ld	a2,1600(a2) # 1d80 <sharedmem+0x3c>
    ...
    1774:	00757713          	andi	a4,a0,7
{
    ...
    17a4:	5e853503          	ld	a0,1512(a0) # 1d88 <sharedmem+0x44>
    ...
    17b6:	5c68b883          	ld	a7,1478(a7) # 1d78 <sharedmem+0x34>
    17ba:	00000817          	auipc	a6,0x0
    17be:	5c683803          	ld	a6,1478(a6) # 1d80 <sharedmem+0x3c>
    17c2:	431d                	li	t1,7
...
char* stpcpy(char* restrict d, const char* s)
{
    ...
    1844:	53863603          	ld	a2,1336(a2) # 1d78 <sharedmem+0x34>
    1848:	00000817          	auipc	a6,0x0
    184c:	53883803          	ld	a6,1336(a6) # 1d80 <sharedmem+0x3c>
...
char* stpncpy(char* restrict d, const char* s, size_t n)
{
    ...
    1a26:	3568b883          	ld	a7,854(a7) # 1d78 <sharedmem+0x34>
    1a2a:	00000817          	auipc	a6,0x0
    1a2e:	35683803          	ld	a6,854(a6) # 1d80 <sharedmem+0x3c>
    1a32:	431d                	li	t1,7
